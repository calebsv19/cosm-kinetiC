...
enum {
    ...
    MENU_SETTINGS_PANEL_TOP_OFFSET = 36,
    MENU_SETTINGS_PANEL_COL_GAP = 8,
    MENU_SETTINGS_PANEL_ROW_GAP = 6,
    MENU_SETTINGS_PANEL_CELL_H = 38,
    MENU_SETTINGS_PANEL_TOGGLE_H = 28,
    MENU_SETTINGS_PANEL_ACTION_H = 28,
    MENU_SETTINGS_PANEL_SECTION_GAP = 8,
    MENU_SETTINGS_PANEL_STATUS_H = 16,
    MENU_SETTINGS_PANEL_BOTTOM_PAD = 8,
    MENU_SETTINGS_PANEL_ICON_W = 28
};
