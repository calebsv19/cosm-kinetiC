...
SDL_Color COLOR_BG        = {20, 22, 26, 255};
SDL_Color COLOR_PANEL     = {32, 36, 40, 255};
SDL_Color COLOR_TEXT      = {245, 247, 250, 255};
SDL_Color COLOR_TEXT_DIM  = {190, 198, 209, 255};
SDL_Color COLOR_FIELD_ACTIVE = {24, 26, 33, 255};
SDL_Color COLOR_FIELD_BORDER = {90, 170, 255, 255};
SDL_Color COLOR_STATUS_OK   = {120, 210, 150, 255};
SDL_Color COLOR_STATUS_WARN = {235, 198, 110, 255};
SDL_Color COLOR_STATUS_ERR  = {235, 130, 130, 255};
...
void scene_editor_panel_draw(SceneEditorState *state) {
    ...
    draw_text(renderer, state->font_main,
              ...
              COLOR_TEXT);
    scene_editor_panel_draw_scene_library_summary(state);
    draw_text(renderer, state->font_main,
              "Viewport",
    ...
    if (state->showing_import_picker) {
        ...
        if (physics_sim_editor_session_has_retained_scene(&state->session)) {
            scene_editor_panel_draw_retained_object_list(state);
            scene_editor_panel_draw_left_object_info_card(state);
        } else {
            scene_editor_panel_draw_object_list(state);
        }
    }
