...
enum {
    ...
    MENU_SETTINGS_PROVIDER_BIT_ATMOSPHERIC_2D = 1u << MENU_SETTINGS_PROVIDER_ATMOSPHERIC_2D,
    MENU_SETTINGS_PROVIDER_BIT_ATMOSPHERIC_3D = 1u << MENU_SETTINGS_PROVIDER_ATMOSPHERIC_3D,
    MENU_SETTINGS_PROVIDER_BIT_WATER = 1u << MENU_SETTINGS_PROVIDER_WATER
};
