...
CFLAGS += -I$(CORE_PACK_DIR)/include -I$(CORE_IO_DIR)/include -I$(CORE_BASE_DIR)/include
...
OBJS += $(CORE_BASE_OBJS) $(CORE_IO_OBJS) $(CORE_PACK_OBJS) $(KIT_VIZ_OBJS)
DEPS := $(OBJS:.o=.d)
CORE_PACK_TOOL_SRCS := \
	$(VF2D_PACK_TOOL_SRC) \
...
CORE_PACK_TOOL_INCS := -I$(CORE_PACK_DIR)/include -I$(CORE_IO_DIR)/include -I$(CORE_BASE_DIR)/include
...
#  Top-level targets
# =========================
.PHONY: all run clean video vf2d_pack_tool vf2d_to_pack test-kitviz-field-adapter
...
clean:
	rm -rf $(BUILD_DIR) $(TARGET) $(VF2D_PACK_TOOL_BIN)
